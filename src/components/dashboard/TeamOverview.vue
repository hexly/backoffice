              ...
              <v-timeline-item class="pb-1">
                ...
                <v-row class="pt-1">
                  ...
                  <v-col class="text-center">
                    ...
                    <Trend v-if="showTrend && !selectedPeriod.metadata && current" :previous="previous.downlineCount.qualified" :current="current.downlineCount.qualified"/>
                  </v-col>
                </v-row>
              </v-timeline-item>
                ...
                <v-timeline-item color="grey" small v-for="(value, key) in stats.levelCounts" :key="key" class="pb-1">
                  <v-row class="pt-1">
                    ...
                    <v-col class="text-center">
                      ...
                      <Trend v-if="showTrend && current" :previous="getPrevious(key)" :current="current.levelCounts[key].qualified"/>
                    </v-col>
                  </v-row>
                </v-timeline-item>
              </template>
